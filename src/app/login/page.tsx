    ...
    <div>
      ...
      <div className="flex justify-center -mt-36 -mt-lg-28 p-3 p-lg-0">
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 w-[552px] bg-white rounded-md shadow-md py-6">
          <h2 className="text-center text-[32px] font-normal capitalize">login</h2>
          ...
          <div className="my-6">
            <button type="submit" className="p-3 bg-primary text-white capitalize text-center rounded-md w-full">login</button>
          </div>
          <p className="text-center">Don’t have an account? <Link href='register' className="text-primary underline">Create an account</Link></p>
        </form>
      </div>
        </main>}
